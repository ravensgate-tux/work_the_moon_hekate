...
魔術師によっては、感情を二元論的に定義する試みもありますが、よく考えて欲しいのは、実際の場面は複雑すぎて、具体的な事項が存在しないのです。たとえば言葉の定義では「喜び」の反対を「悲しみ」と定義できますが、現実社会での「具体的な喜び」に対する反対「具体的な悲しみ」などは一義に決まりません。なので感情についても二元論を消していくことが重要なのです。
